...
const STYLES = [
  {
    name: 'Бальні танці',
    icon: '🩰',
    desc: 'Вальс, танго, фокстрот і квікстеп. Розвиває поставу, відчуття ритму та елегантність руху.',
    col: C.purple,
  },
  {
    name: 'Хіп-хоп',
    icon: '🎤',
    desc: 'Енергійний вуличний стиль. Розвиває пластику, впевненість та творче самовираження.',
    col: C.gold,
  },
  {
    name: 'Контемп',
    icon: '🌊',
    desc: 'Сучасна хореографія на основі імпровізації та вираження емоцій через пластику тіла.',
    col: '#06b6d4',
  },
];
...
const PRICES = [
  {
    ...
    price: '150 грн',
    per: '',
    desc: 'Одне заняття для знайомства зі студією',
    features: ['1 заняття', 'Будь-який напрямок', "Без зобов'язань"],
    hot: false,
  },
  {
    title: 'Абонемент',
    price: '800 грн',
    per: '/місяць',
    desc: '8 занять — найпопулярніший вибір',
    features: [
      '8 занять на місяць',
      'Один напрямок',
      'Знижка 20%',
  ...
  },
  {
    ...
    price: '1200 грн',
    per: '/місяць',
    desc: 'Для справжніх танцюристів',
    features: [
      'Необмежені заняття',
      'Всі напрямки',
      'Пріоритетний запис',
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            Місце, де рух стає мистецтвом. Бальні танці, хіп-хоп та контемп для
            дітей 6–14 років.
          </p>
          <div
            style={{
      ...
      <section
        id="about"
        style={{ padding: '90px 24px', maxWidth: 860, margin: '0 auto' }}
      >
        ...
        >
          <b style={{ color: C.text }}>Dance Prostir</b> — це простір для
          творчості, руху та розвитку дитини. Ми створили студію, де кожна
          дитина відкриває свій талант, знаходить друзів і вчиться виражати себе
          через танець.
        </p>
        <div
          style={{
      ...
      <section
        id="styles"
        style={{ padding: '90px 24px', background: C.surface }}
      >
      ...
      >
        ...
        >
          ...
          <div style={{ maxWidth: 480 }}>
            <h3 style={{ fontSize: 26, fontWeight: 800, margin: '0 0 4px' }}>
              Ім'я Прізвище
            </h3>
            <div style={{ color: C.purple, fontWeight: 600, marginBottom: 18 }}>
              Сертифікований хореограф
            </div>
            <p
              style={{
                color: C.light,
            ...
            >
              Понад 10 років досвіду у викладанні танців для дітей та молоді.
              Спеціалізується на бальних танцях, хіп-хопі та контемпорарі.
              Переможець регіональних та всеукраїнських змагань.
            </p>
            <p
              style={{
                color: C.light,
            ...
            >
              Індивідуальний підхід до кожного учня, позитивна атмосфера та
              любов до танцю — це основа нашої студії.
            </p>
            <div
              style={{
                display: 'flex',
            ...
            >
              {['Бальні', 'Хіп-хоп', 'Контемп', 'Дитяча хореографія'].map(
                (t) => (
                  <span
                    key={t}
                    style={{
      ...
      <section
        id="prices"
        style={{ padding: '90px 24px', maxWidth: 920, margin: '0 auto' }}
      >
        <STitle>Ціни</STitle>
        <div
          style={{
        ...
        >
          {PRICES.map((p) => (
            <div
              ...
              style={{
                background: p.hot
                  ? `linear-gradient(160deg, rgba(139,92,246,0.18), rgba(139,92,246,0.08))`
                  : C.card,
                border: p.hot
                  ? `2px solid ${C.purple}`
                  : `1px solid ${C.border}`,
      ...
      >
        <div style={{ maxWidth: 580, margin: '0 auto' }}>
          ...
          {showCfg && (
            ...
            >
              <p
                style={{ color: C.light, margin: '0 0 12px', fontWeight: 600 }}
              >
                🔗 Підключення до Notion через Make.com / Zapier
              </p>
              <ol
                style={{
                  color: C.muted,
              ...
              >
                <li>
                  Зареєструйтесь на <b style={{ color: C.light }}>make.com</b>
                </li>
                <li>
                  Створіть сценарій:{' '}
                  <b style={{ color: C.light }}>
              ...
              <p style={{ color: '#555', fontSize: 11, marginTop: 8 }}>
                Поля, що передаються: name, phone, age, style, timestamp
              </p>
            </div>
          )}
          ...
          {status === 'done' ? (
            ...
            >
              ...
              <p style={{ color: C.light, lineHeight: 1.7 }}>
            ...
            >
              ...
              >
                {[
                  ...
                  {
                    k: 'phone',
                    label: 'Номер телефону батьків',
                    ph: '+380 XX XXX XX XX',
                    type: 'tel',
                  },
                  {
                    k: 'age',
                    label: 'Вік дитини (6–14 років)',
                    ph: 'Наприклад: 9',
                    type: 'number',
                  },
                ].map((f) => (
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ ...inp, color: form.style ? C.text : '#555' }}
                  >
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    opacity:
                      !form.name || !form.phone || !form.age || !form.style
                        ? 0.5
                        : 1,
                    marginTop: 4,
                  }}
          ...
          {[
            {
              icon: '📍',
              label: 'Адреса',
              val: 'Печерський узвіз, 3, Київ 02000',
            },
        ...
        >
          {[
            ...
            [
              'Facebook',
              '👥',
              'https://www.facebook.com/people/Dance-Prostir/100086073223400/',
            ],
          ].map(([n, ic, url]) => (
            <a
              key={n}
      ...
      >
        <div style={{ fontWeight: 800, fontSize: 20, marginBottom: 10 }}>
          <span style={{ color: C.purple }}>Dance</span>{' '}
          <span style={{ color: C.gold }}>Prostir</span>
        </div>
        <div style={{ color: C.muted, fontSize: 13, marginBottom: 6 }}>
          📍 Печерський узвіз, 3, Київ 02000
        </div>
        <div
          style={{
            display: 'flex',
        ...
        >
          <a
            href="https://www.instagram.com/dance_prostir/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.facebook.com/people/Dance-Prostir/100086073223400/"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: C.muted, fontSize: 13, textDecoration: 'none' }}
          >
          ...
          <a
            href="https://maps.app.goo.gl/qysdY3HJLLfoa53P9"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: C.muted, fontSize: 13, textDecoration: 'none' }}
          >
        ...
        <div style={{ color: '#444', fontSize: 12 }}>
          © 2025 Dance Prostir. Всі права захищені.
        </div>
      </footer>
    </div>
  );
